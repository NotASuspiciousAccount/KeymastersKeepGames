...
-Traversals: Travel from one region to another without using teleporters. Difficult checks can prohibit the use of movement options, and time-consuming checks can add a third location to travel to.

-New Save Files: Start a new save file, and complete an objective. Currently, these checks only appear if time-consuming checks are also enabled. Difficult checks extend these tasks even further.
